...
class SubjectModel(object):
    ...
    def setup_model_db(self, textSample=None, sentenceSep='[.!?\n]', n=2, source='wikipedia'):
        """
        Generate a MarkovChain model for the requested word.
        :param textSample: The sample of text to base the model off of
        :param sentenceSep: A list of different seperators for sentences
        :param n:
        ...
        textSample = _wordIter(self.sample_text,
                               sentenceSep)  # get an iterator for the 'sentences'
